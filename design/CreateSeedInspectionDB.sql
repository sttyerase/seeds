...
-- -----------------------------------------------------
-- Table `SeedInspectionDB`.`varieties`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `SeedInspectionDB`.`samples`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `SeedInspectionDB`.`germinations`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SeedInspectionDB`.`germinations` ;

CREATE TABLE IF NOT EXISTS `SeedInspectionDB`.`germinations` (
  `germination_id` INT NOT NULL COMMENT 'germinated + weak + dead = 100\n',
...
CREATE INDEX `fk_germinations_samples1_idx` ON `SeedInspectionDB`.`germinations` (`germination_sample_id` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `SeedInspectionDB`.`purities`
-- -----------------------------------------------------
...
CREATE INDEX `fk_purities_samples1_idx` ON `SeedInspectionDB`.`purities` (`purity_sample_id` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `SeedInspectionDB`.`producer_privacy_keys`
-- -----------------------------------------------------
...
CREATE INDEX `fk_producer_pkkeys_producers1_idx` ON `SeedInspectionDB`.`producer_privacy_keys` (`producer_pkkeys_producer_id` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `SeedInspectionDB`.`fields`
-- -----------------------------------------------------
...
CREATE INDEX `fk_fields_producers1_idx` ON `SeedInspectionDB`.`fields` (`field_producer_id` ASC) VISIBLE;

CREATE INDEX `fk_fields_varieties1_idx` ON `SeedInspectionDB`.`fields` (`field_variety_id` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `SeedInspectionDB`.`fieldinspections`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `SeedInspectionDB`.`producer_details`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SeedInspectionDB`.`producer_details` ;

CREATE TABLE IF NOT EXISTS `SeedInspectionDB`.`producer_details` (
  `producer_detail_id` BIGINT NOT NULL,
  `producer_detail_producer_id` BIGINT NOT NULL,
  `pd_name` VARCHAR(45) NULL,
  `pd_address1` VARCHAR(45) NULL,
  `pd_address2` VARCHAR(45) NULL,
  `pd_state` VARCHAR(45) NULL,
  `pd_zip` VARCHAR(45) NULL,
  `pd_phone1` VARCHAR(45) NULL,
  `pd_phone2` VARCHAR(45) NULL,
  `pd_site_image` LONGBLOB NULL,
  PRIMARY KEY (`producer_detail_id`),
  CONSTRAINT `fk_producer_details_producers1`
    FOREIGN KEY (`producer_detail_producer_id`)
    REFERENCES `SeedInspectionDB`.`producers` (`producer_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `fk_producer_details_producers1_idx` ON `SeedInspectionDB`.`producer_details` (`producer_detail_producer_id` ASC) VISIBLE;

SET SQL_MODE = '';
DROP USER IF EXISTS seedmgr;
SET SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';
CREATE USER 'seedmgr' IDENTIFIED BY 'daLLman8';

GRANT ALL ON `SeedInspectionDB`.* TO 'seedmgr';
GRANT ALL ON TABLE `SeedInspectionDB`.`fields` TO 'seedmgr';
GRANT ALL ON TABLE `SeedInspectionDB`.`crops` TO 'seedmgr';
GRANT ALL ON TABLE `SeedInspectionDB`.`germinations` TO 'seedmgr';
GRANT ALL ON TABLE `SeedInspectionDB`.`producer_privacy_keys` TO 'seedmgr';
GRANT ALL ON TABLE `SeedInspectionDB`.`producers` TO 'seedmgr';
GRANT ALL ON TABLE `SeedInspectionDB`.`purities` TO 'seedmgr';
GRANT ALL ON TABLE `SeedInspectionDB`.`samples` TO 'seedmgr';
GRANT ALL ON TABLE `SeedInspectionDB`.`varieties` TO 'seedmgr';
